...
t_bool	ft_frwlist_insert(t_ftfrwlist *this, size_t index, void *value)
{
...
t_bool	ft_frwlist_push_front(t_ftfrwlist *this, void *value)
{
	return (ft_frwlist_insert(this, 0, value));
}

t_bool	ft_frwlist_push_back(t_ftfrwlist *this, void *value)
{
