...
static inline t_bool	insert(t_ftmap *this, const char *key, void *value)
{
	size_t			index;
	t_ftfrwlist		*bucket;
	t_ftmap_node	*node;
...
t_bool	ft_map_insert(t_ftmap *this, const char *key, void *value)
{
	char		*copy_key;
...
t_bool	ft_map_insert_n(t_ftmap *this, const char *key, size_t key_size,
						void *value)
{
	char		*copy_key;
