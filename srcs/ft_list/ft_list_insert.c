...
t_bool	ft_list_insert(t_ftlist *this, size_t index, void *value)
{
...
t_bool	ft_list_push_front(t_ftlist *this, void *value)
{
	return (ft_list_insert(this, 0, value));
}

t_bool	ft_list_push_back(t_ftlist *this, void *value)
{
